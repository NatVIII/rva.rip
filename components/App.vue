  ...
  <ModalsContainer />
    <div class="calendar-container">
      ...
      <div style="display: flex; align-items: center; flex-direction: row;">
        <div class="desc">
          <p>The events here are drawn from various <a href="https://github.com/ivyraine/bay.lgbt/blob/main/public/event_sources.json">organizer listings</a> that contributors (thank you!) have provided. The listings are in a constant state of community-based vetting; don't hesitate to provide feedback <a href="https://forms.gle/DMt1xKyMKbHCsZMv5">here</a>!</p>
